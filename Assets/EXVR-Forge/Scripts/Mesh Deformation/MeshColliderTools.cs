...
static public class MeshColliderTools
{
    ...
    public static Mesh Simplify(this Mesh mesh)
    {
        var verts = mesh.vertices;
        ...
        simplifiedMesh.vertices = newPositions;
        simplifiedMesh.triangles = resultTris.ToArray();
    ...
    private class Edge
    {
        ...
        public static void Collapse(Edge moved, Edge target, Face f)
        {
            ...
            {
                throw new Exception(e.Message + "\n" + moved.vertices[0].position.ToString("0.00") + " <--> " + moved.vertices[1].position.ToString("0.00"));
            }
