...
public class STL
{
	...
	{
		string filePath = ExportPath() + "/" + SceneManager.GetActiveScene().name + "_" + DateTimeCode() + ".stl";
		ExportBinary(filters, filePath);
		return filePath;
	}


    public static void ExportBinary(MeshFilter filter, string filePath, string fileName = "")
	{
		ExportBinary(new MeshFilter[]{ filter }, filePath, fileName);
	}
	
	
	public static void ExportBinary(MeshFilter[] filters, string filePath, string fileName = "")
	{
        Directory.CreateDirectory(filePath);

        if (fileName == "")
            fileName = SceneManager.GetActiveScene().name + "_" + DateTimeCode() + ".stl";
        else fileName = fileName + "_" + DateTimeCode() + ".stl";
